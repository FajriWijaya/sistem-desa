            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('keluarga.update', $keluarga->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kepala_keluarga_id" class="form-select" id="select-penduduk"
                                                ...
                                                @foreach ($kepalaKeluarga as $d)
                                                    <option value="{{ $d->id }}" {{ $keluarga->kepala_keluarga_id == $d->id ? 'selected' : '' }}> {{ $d->nik }} -
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control" name="alamat"
                                                placeholder="Alamat" value="{{ $keluarga->alamat }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class='form-group'>
                                            ...
                                            <select name="rt_id" class="form-select" id="rt-column" required>
                                                ...
                                                @foreach ($rt as $r)
                                                    <option value="{{ $r->id }}" {{ $keluarga->rt_id == $r->id ? 'selected' : '' }}> {{ $r->no_rt }}</option>
                                                @endforeach
                                            </select>
