...
@section('content')
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Penduduk Keluar RW {{ $rw->no_rw }}</h3>
                ...
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page">
                            <a href="{{ route('pindah_keluar.rw') }}">Dusun</a>
                        </li>
    ...
    <section class="section">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('pindah_keluar.filter', $rw->no_rw) }}" method="post">
                    @csrf
                    <div class="row g-3">
                        ...
                        <div class="col-12 d-flex justify-content-end gap-2 mt-3">
                            <a href="{{ route('pindah_keluar', $rw->no_rw) }}" class="btn btn-secondary">
    ...
    <section class="section">
        ...
        <div class="card">
            ...
            <div class="d-flex mb-3 me-4 justify-content-end gap-2">
                <a href="{{ route('pindah_keluar.pdf', $rw->no_rw) }}" target="_blank" class="btn btn-outline-danger">
                    <i class="fa-solid fa-file-pdf"></i>
                </a>

                <a href="{{ route('pindah_keluar.print', $rw->no_rw) }}" target="_blank" class="btn btn-outline-info">
                    <i class="fa-solid fa-print"></i>
                </a>
                <a href="{{ route('pindah_keluar.create', $rw->no_rw) }}" class="btn btn-outline-primary">
                    ...
                    <tbody>
                        @foreach ($penduduk as $item)
                            <tr>
                                ...
                                <td>{{ $item->perpindahan->rt_asal ?? '-' }}</td>
                                <td>{{ $item->perpindahan->rw_asal ?? '-' }}</td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end gap-1">
                                        <a href="{{ route('pindah_keluar.edit', $item->perpindahan->id) }}"
