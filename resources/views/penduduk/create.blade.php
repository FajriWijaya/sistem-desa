                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="mutasi" id="mutasi" class="form-control">
                                                ...
                                                <option value="pindah_masuk"
                                                    {{ old('mutasi') == 'pindah_masuk' ? 'selected' : '' }}>Pindah Masuk
                                                </option>
                                                <option value="kelahiran"
                                                    {{ old('mutasi') == 'kelahiran' ? 'selected' : '' }}>
                                                    Kelahiran</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class='form-group'>
                                            ...
                                            <label for="nama-ibu-column"></label>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class='form-group'>
                                            ...
                                            <input type="text" id="rw-column" name="rw" class="form-control"
                                                placeholder="rw" value="{{ old('rw', $rw->no_rw) }}" readonly>
                                            <input type="number" name="rw_id" value="{{ $rw->id }}" hidden>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class='form-group'>
                                            ...
                                            <input type="text" name="profesi" id="profesi-column"
                                                class="form-control" placeholder="Profesi" value="{{ old('profesi') }}"
                                                required>
                                    ...
                                    <div id="form-pindah" style="display: none; margin-top:20px;">
                                        ...
                                        <input type="text" name="alasan_perpindahan" placeholder="Alasan Perpindahan"
                                            class="form-control mb-2">
                                        <input type="text" id="tanggal_pelaporan" name="tanggal_pelaporan"
                                            class="form-control mb-2" placeholder="Tanggal Pelaporan">
                                    </div>


                                    <div id="form-lahir" style="display: none; margin-top:20px;">
