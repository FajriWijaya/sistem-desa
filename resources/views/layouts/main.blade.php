...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/mazer/dist/assets/chhiixxxxxxxxompiled/svg/favicon.svg') }}"
        type="image/x-icon" />
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/7.0.1/css/all.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&icon_names=family_restroom" />
    <style>
        .custom-card {
            border: none;
            border-radius: 14px;
